...
class ApiStore {
	countPhoto = Storage.getNumber('countPhoto')
		? Storage.getNumber('countPhoto')
		: 30
	maxDistance = Storage.getNumber('MaxDistance')
		? Storage.getNumber('MaxDistance')
		: 7000
	themeSettings = Storage.getString('theme')
