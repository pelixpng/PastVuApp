    ...
    if (value === 'yandex') {
      Alert.alert(
        ...
        'Карта находится в ранней версии, возможны баги и нестабильная работа.\n\n' +
          ...
          `Бесплатный API Яндекс Карт рассчитан на 1000 пользователей в день. Если карта не загружается — лимит возможно уже исчерпан. В таком случае рекомендуется переключиться на ${Platform.OS === 'ios' ? 'Apple Maps' : 'Google Maps'}.`,
        [{ text: 'Понятно' }],
      )
    }
